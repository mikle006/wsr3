...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 24 2021 г., 22:50
...
CREATE TABLE `request` (
  ...
  `why_not` text DEFAULT NULL COMMENT 'Причина отказа',
...
(8, 'Решена', 'pepachka', 'uploads/ygeFYHcYHt4.jpg', '', 'ыф', 1, '2021-05-24 21:05:34', 100, 100);
